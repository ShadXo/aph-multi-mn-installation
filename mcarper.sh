...
"
  ...
  (
    ...
    then
      ...
      then
        sudo -n ss -lpn 2>/dev/null  | grep ":${10} "
        echo
...
${TEMP_FILE}
  ...
  (
    ...
    then
      ...
      sudo sed -i "s/${1}/${10}/g" "/etc/sudoers.d/${1}"
      sudo sed -i "s/${1}$/${10}/g" "/etc/sudoers.d/${1}"
      sudo sed -i "s/${1} /${10} /g" "/etc/sudoers.d/${1}"
      sudo sed -i "s/${1}\./${10}./g" "/etc/sudoers.d/${1}"
      sudo mv "/etc/sudoers.d/${1}" "/etc/sudoers.d/${10}"
    fi
